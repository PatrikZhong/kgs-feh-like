...
- Add interesting sidenodes
- Add more complicated graph paths. 
...
- Implement special tiles -> special tile backgrounds, special effects if standing on them. 

## Items

- Implement inventory slots and items


## ART

- We need in-world pixel sprites and full on character sprites. 