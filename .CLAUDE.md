...
- **One move per turn:** moving a unit immediately ends the player's turn. There is no multi-unit selection.
- This is intentional — it enforces the fast, blitz-chess pace of the game.
